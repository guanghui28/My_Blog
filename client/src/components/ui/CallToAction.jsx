...
const CallToAction = () => {
	return (
		<div className="flex flex-col sm:flex-row p-3 border border-teal-500 justify-center items-center rounded-tf-3xl rounded-br-3xl rounded-tl-3xl text-center">
